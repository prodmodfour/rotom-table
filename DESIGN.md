...
`IMPLEMENTATION_PLAN: ENCOUNTER_UI_UX_PLAN.md`
...
`DESIGN.md` is normative. `ENCOUNTER_UI_UX_PLAN.md` is the implementation ledger. Automation plans own mechanics and authority.
