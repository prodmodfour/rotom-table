...
## Ticket 1 - Clarify the existing auto-calc all control
...
## Ticket 2 - Add persisted manual order to map initiative state
...
## Ticket 3 - Add shared manual-order merge helpers
...
## Ticket 4 - Thread manual order through server-side order entry utilities
...
## Ticket 5 - Make the client tracker read and mutate manual order locally
...
## Ticket 6 - Auto-calc all clears manual order
...
## Ticket 7 - Expose manual reorder events through the modal component chain
...
## Ticket 8 - Add keyboard-accessible row move controls
...
## Ticket 9 - Add a reset manual order control
...
## Ticket 10 - Add pointer drag reorder inside the initiative list
...
## Ticket 11 - Extend live-play and session payload types for manual order
...
## Ticket 12 - Apply manual order in live-play initiative commands
...
## Ticket 13 - Apply manual order in legacy/session initiative commands
...
## Ticket 14 - Update live-play patch adoption for manual order
...
## Ticket 15 - Wire manual order commands from the client tracker in live play
...
## Ticket 16 - Polish modal layout for initiative as a primary control surface
...
## Ticket 17 - Add end-to-end-ish regression coverage for the full flow
...
## Ticket 18 - Final typecheck, full test run, and cleanup
