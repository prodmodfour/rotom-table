...
CURRENT_NEXT_STEP: Continue one bounded cleanup phase; the shared library card media tile is now isolated, but small UI/helper cleanup remains and the refactor is not marked complete.
