...
## LP-S2-001 — Add command lifecycle tracing for live-play dispatch
...
## LP-S2-002 — Add a focused live-play latency debug panel behind a query flag
...
## LP-S2-003 — Add prediction conflict detection for incoming authoritative patches
...
## LP-S2-004 — Add an authoritative patch adoption hook around local predictions
...
## LP-S2-005 — Rebase non-conflicting predictions after remote accepted patches
...
## LP-S2-006 — Harden stale HTTP terminal responses after SSE-first adoption
...
## LP-S2-007 — Harden HTTP-first then SSE replay ordering
...
## LP-S2-008 — Add pending prediction reconciliation on reconnect/gap recovery
...
## LP-S2-009 — Add command-status awareness for pending predictions
...
## LP-S2-010 — Add prediction-safe same-token movement queue tests for revision changes
...
## LP-S2-011 — Predict simple HP edits for local token HUD only
...
## LP-S2-012 — Predict simple condition edits as token-level pending feedback
...
## LP-S2-013 — Add prediction-aware correction notice lifetime and deduping
...
## LP-S2-014 — Add live-play prediction chaos tests
...
## LP-S2-015 — Add operator smoke notes for prediction hardening
