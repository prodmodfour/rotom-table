...
describe('Live session security readiness audit', () => {
  ...
  it('is linked from primary security and Live session docs', () => {
    expect(readText('README.md')).toContain('docs/live-session-security-readiness-audit.md')
    expect(readText('docs/README.md')).toContain('live-session-security-readiness-audit.md')
    expect(readText('SECURITY.md')).toContain('docs/live-session-security-readiness-audit.md')
    expect(readText('docs/live-session-roadmap.md')).toContain('live-session-security-readiness-audit.md')
    expect(readText('docs/live-session-validation-matrix.md')).toContain('live-session-security-readiness-audit.md')
    expect(readText('docs/live-session-protocol.md')).toContain('live-session-security-readiness-audit.md')
    expect(readText('docs/live-session-security-review.md')).toContain('live-session-security-readiness-audit.md')
    expect(readText('docs/live-session-public-exposure-checks.md')).toContain('live-session-security-readiness-audit.md')
  })
})
