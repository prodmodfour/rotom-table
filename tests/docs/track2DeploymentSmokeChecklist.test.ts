...
describe('Track 2 deployment smoke checklist', () => {
  const checklist = readText('docs/track-2-deployment-smoke-checklist.md')
  ...
  it('is linked from primary Track 2 hosting and operations docs', () => {
    expect(readText('README.md')).toContain('docs/track-2-deployment-smoke-checklist.md')
    expect(readText('docs/README.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/local-development.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-roadmap.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-validation-matrix.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-lan-hosting.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-cloudflare-tunnel-hosting.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-session-host-runtime.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-session-lobby.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-session-protocol.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-websocket-protocol.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-multi-tab-smoke.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-public-exposure-checks.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-quick-tunnel-caveat.md')).toContain('track-2-deployment-smoke-checklist.md')
    expect(readText('docs/track-2-security-review.md')).toContain('track-2-deployment-smoke-checklist.md')
  })
})
