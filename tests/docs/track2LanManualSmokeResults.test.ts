...
describe('Track 2 LAN manual smoke results docs', () => {
  const results = readText('docs/track-2-lan-manual-smoke-results.md')
  ...
  it('is linked from the main Track 2 docs', () => {
    expect(readText('README.md')).toContain('docs/track-2-lan-manual-smoke-results.md')
    expect(readText('docs/README.md')).toContain('track-2-lan-manual-smoke-results.md')
    expect(readText('docs/track-2-lan-hosting.md')).toContain('track-2-lan-manual-smoke-results.md')
    expect(readText('docs/track-2-deployment-smoke-checklist.md')).toContain('track-2-lan-manual-smoke-results.md')
    expect(readText('docs/track-2-session-protocol.md')).toContain('track-2-lan-manual-smoke-results.md')
    expect(readText('docs/track-2-websocket-protocol.md')).toContain('track-2-lan-manual-smoke-results.md')
    expect(readText('docs/track-2-validation-matrix.md')).toContain('track-2-lan-manual-smoke-results.md')
  })
})
