...
describe('Track 2 named Cloudflare Tunnel runbook', () => {
  ...
  it('is linked from primary Track 2 docs', () => {
    expect(readText('README.md')).toContain('docs/track-2-cloudflare-tunnel-hosting.md')
    expect(readText('docs/README.md')).toContain('track-2-cloudflare-tunnel-hosting.md')
    expect(readText('docs/local-development.md')).toContain('track-2-cloudflare-tunnel-hosting.md')
    expect(readText('docs/track-2-roadmap.md')).toContain('track-2-cloudflare-tunnel-hosting.md')
