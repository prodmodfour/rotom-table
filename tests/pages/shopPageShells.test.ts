...
describe('shop page shells', () => {
  it('adds a GM shop library page while leaving the player shop browser shell untouched', () => {
    ...
    expect(source).toContain('type PlayerShopLibraryShellStatus = \'loading\' | \'empty\' | \'error\'')
    ...
    expect(source).toContain('Open, player-visible shopfronts will appear here once the browser is wired.')
