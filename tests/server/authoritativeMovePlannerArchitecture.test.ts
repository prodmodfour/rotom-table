...
const planningPathFiles = [
  ...
  'server/domain/moveAutomation/reducers/conditionEncounterState.ts',
  'server/domain/moveAutomation/reducers/conditionError.ts',
  'server/domain/moveAutomation/reducers/conditionRules.ts',
