...
import {
  BABY_DOLL_EYES_REG_003_SCENARIOS,
  BITE_REG_003_SCENARIOS,
  BLAZE_KICK_REG_003_SCENARIOS,
  BLEAKWIND_STORM_REG_003_SCENARIOS,
  BLUE_FLARE_REG_003_SCENARIOS,
  BODY_SLAM_REG_003_SCENARIOS,
  BOLT_STRIKE_REG_003_SCENARIOS,
  BONE_CLUB_REG_003_SCENARIOS,
  REG_003_MOVE_NAMES,
  REG_003_SCENARIOS_BY_MOVE,
  type RegisteredBatch003MoveName,
} from '../fixtures/moveAutomation/registeredBatch003'
...
interface LegacyExecutionScenario {
  ...
  readonly moveName: RegisteredBatch003MoveName
...
const fixtureFor = (
  ...
  const targetIds = scenario.areaTargetIds ?? [TARGET_A_ID]
  const map: TabletopMap = {
    schemaVersion: 2,
    slug: `reg-003-${scenario.scenarioId.replace(/[^a-z0-9]+/gi, '-').toLowerCase()}`,
    name: `REG-003 ${scenario.moveName}`,
    revision: 7,
    ...
    activeScene: { name: 'REG-003 scene', startedAt: 100 },
...
const executeCommand = async (
  ...
  idFactory: (() => {
    let sequence = 0
    return () => `reg-003-id-${++sequence}`
  })(),
  relativePath: path => path,
})

const flinch = { [TARGET_A_ID]: ['Flinch', 'Vulnerable'] } as const
const burned = { [TARGET_A_ID]: ['Burned'] } as const
const paralysis = { [TARGET_A_ID]: ['Paralysis'] } as const
const bleakwindBoth = { [TARGET_A_ID]: ['Frozen', 'Flinch', 'Vulnerable'] } as const

const normalScenarios: readonly LegacyExecutionScenario[] = [
  {
    scenarioId: BABY_DOLL_EYES_REG_003_SCENARIOS[0].scenarioId,
  ...
  {
    scenarioId: BABY_DOLL_EYES_REG_003_SCENARIOS[1].scenarioId,
    moveName: 'Baby-Doll Eyes',
    randomValues: [0],
    expectedAttackedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BABY_DOLL_EYES_REG_003_SCENARIOS[2].scenarioId,
    moveName: 'Baby-Doll Eyes',
    randomValues: [0.45],
  ...
  {
    scenarioId: BITE_REG_003_SCENARIOS[0].scenarioId,
    moveName: 'Bite',
    randomValues: [0.7, 0, 0],
    expectedConditions: flinch,
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BITE_REG_003_SCENARIOS[1].scenarioId,
    moveName: 'Bite',
  ...
  {
    scenarioId: BITE_REG_003_SCENARIOS[2].scenarioId,
    moveName: 'Bite',
    randomValues: [0],
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [],
  ...
  {
    scenarioId: BITE_REG_003_SCENARIOS[3].scenarioId,
    moveName: 'Bite',
  ...
  {
    scenarioId: BITE_REG_003_SCENARIOS[4].scenarioId,
    moveName: 'Bite',
    randomValues: [0.7, 0, 0],
  ...
  {
    scenarioId: BLAZE_KICK_REG_003_SCENARIOS[0].scenarioId,
    moveName: 'Blaze Kick',
  ...
  {
    scenarioId: BLAZE_KICK_REG_003_SCENARIOS[1].scenarioId,
    moveName: 'Blaze Kick',
  ...
  {
    scenarioId: BLAZE_KICK_REG_003_SCENARIOS[2].scenarioId,
    moveName: 'Blaze Kick',
  ...
  {
    scenarioId: BLAZE_KICK_REG_003_SCENARIOS[3].scenarioId,
    moveName: 'Blaze Kick',
    randomValues: [0],
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [],
  ...
  {
    scenarioId: BLAZE_KICK_REG_003_SCENARIOS[4].scenarioId,
    moveName: 'Blaze Kick',
    randomValues: [0.9, 0, 0],
  ...
  {
    scenarioId: BLAZE_KICK_REG_003_SCENARIOS[5].scenarioId,
    moveName: 'Blaze Kick',
    randomValues: [0.9, 0, 0],
    targetTypes: ['Fire'],
    expectedAttackedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BLEAKWIND_STORM_REG_003_SCENARIOS[0].scenarioId,
    moveName: 'Bleakwind Storm',
    areaTargetIds: [TARGET_A_ID, TARGET_B_ID],
    randomValues: [0.7, 0, 0, 0, 0, 0, 0, 0],
    expectedConditions: flinch,
  ...
  {
    scenarioId: BLEAKWIND_STORM_REG_003_SCENARIOS[1].scenarioId,
    moveName: 'Bleakwind Storm',
  ...
  {
    scenarioId: BLEAKWIND_STORM_REG_003_SCENARIOS[2].scenarioId,
    moveName: 'Bleakwind Storm',
    areaTargetIds: [TARGET_A_ID],
    randomValues: [0.9, 0, 0, 0],
    expectedConditions: bleakwindBoth,
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [TARGET_A_ID],
    expectedDamagedTargetIds: [TARGET_A_ID],
    expectedAccuracyNaturalResults: [19],
  ...
  {
    scenarioId: BLEAKWIND_STORM_REG_003_SCENARIOS[3].scenarioId,
    moveName: 'Bleakwind Storm',
    areaTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BLEAKWIND_STORM_REG_003_SCENARIOS[4].scenarioId,
    moveName: 'Bleakwind Storm',
    areaTargetIds: [TARGET_A_ID],
    randomValues: [0.9, 0, 0, 0],
    targetTypes: ['Ice'],
  ...
  {
    scenarioId: BLUE_FLARE_REG_003_SCENARIOS[0].scenarioId,
    moveName: 'Blue Flare',
    randomValues: [0.8, 0, 0, 0, 0],
    expectedConditions: burned,
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [TARGET_A_ID],
    expectedDamagedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BLUE_FLARE_REG_003_SCENARIOS[1].scenarioId,
    moveName: 'Blue Flare',
    randomValues: [0.75, 0, 0, 0, 0],
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [TARGET_A_ID],
    expectedDamagedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BLUE_FLARE_REG_003_SCENARIOS[2].scenarioId,
    moveName: 'Blue Flare',
  ...
  {
    scenarioId: BLUE_FLARE_REG_003_SCENARIOS[3].scenarioId,
    moveName: 'Blue Flare',
  ...
  {
    scenarioId: BLUE_FLARE_REG_003_SCENARIOS[4].scenarioId,
    moveName: 'Blue Flare',
    randomValues: [0.8, 0, 0, 0, 0],
    targetAbilities: ['Flash Fire'],
    expectedAttackedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BLUE_FLARE_REG_003_SCENARIOS[5].scenarioId,
    moveName: 'Blue Flare',
    randomValues: [0.8, 0, 0, 0, 0],
    targetTypes: ['Fire'],
    expectedAttackedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BODY_SLAM_REG_003_SCENARIOS[0].scenarioId,
    moveName: 'Body Slam',
    randomValues: [0.7, 0, 0],
  ...
  {
    scenarioId: BODY_SLAM_REG_003_SCENARIOS[1].scenarioId,
    moveName: 'Body Slam',
    randomValues: [0.65, 0, 0],
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BODY_SLAM_REG_003_SCENARIOS[2].scenarioId,
    moveName: 'Body Slam',
    randomValues: [0],
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [],
  ...
  {
    scenarioId: BODY_SLAM_REG_003_SCENARIOS[3].scenarioId,
    moveName: 'Body Slam',
    randomValues: [0.999, 0, 0],
    expectedConditions: paralysis,
    expectedAttackedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BODY_SLAM_REG_003_SCENARIOS[4].scenarioId,
    moveName: 'Body Slam',
    randomValues: [0.7, 0, 0],
    targetTypes: ['Ghost'],
    expectedAttackedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BODY_SLAM_REG_003_SCENARIOS[5].scenarioId,
    moveName: 'Body Slam',
    randomValues: [0.7, 0, 0],
  ...
  {
    scenarioId: BOLT_STRIKE_REG_003_SCENARIOS[0].scenarioId,
  ...
  {
    scenarioId: BOLT_STRIKE_REG_003_SCENARIOS[1].scenarioId,
    moveName: 'Bolt Strike',
    randomValues: [0.75, 0, 0, 0, 0],
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BOLT_STRIKE_REG_003_SCENARIOS[2].scenarioId,
    moveName: 'Bolt Strike',
    randomValues: [0, 0, 0, 0, 0],
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [],
  ...
  {
    scenarioId: BOLT_STRIKE_REG_003_SCENARIOS[3].scenarioId,
    moveName: 'Bolt Strike',
    randomValues: [0.999, 0, 0, 0, 0],
    expectedConditions: paralysis,
    expectedAttackedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BOLT_STRIKE_REG_003_SCENARIOS[4].scenarioId,
    moveName: 'Bolt Strike',
    randomValues: [0.8, 0, 0, 0, 0],
    targetTypes: ['Ground'],
    expectedAttackedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BOLT_STRIKE_REG_003_SCENARIOS[5].scenarioId,
    moveName: 'Bolt Strike',
    randomValues: [0.8, 0, 0, 0, 0],
    targetTypes: ['Electric'],
    expectedAttackedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BONE_CLUB_REG_003_SCENARIOS[0].scenarioId,
    moveName: 'Bone Club',
    randomValues: [0.85, 0, 0],
    expectedConditions: flinch,
    expectedAttackedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BONE_CLUB_REG_003_SCENARIOS[1].scenarioId,
    moveName: 'Bone Club',
    randomValues: [0.8, 0, 0],
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BONE_CLUB_REG_003_SCENARIOS[2].scenarioId,
    moveName: 'Bone Club',
    randomValues: [0],
    expectedAttackedTargetIds: [TARGET_A_ID],
    expectedHitTargetIds: [],
  ...
  {
    scenarioId: BONE_CLUB_REG_003_SCENARIOS[3].scenarioId,
    moveName: 'Bone Club',
    randomValues: [0.999, 0, 0],
    expectedConditions: flinch,
    expectedAttackedTargetIds: [TARGET_A_ID],
  ...
  {
    scenarioId: BONE_CLUB_REG_003_SCENARIOS[4].scenarioId,
    moveName: 'Bone Club',
    randomValues: [0.85, 0, 0],
    targetAbilities: ['Shield Dust'],
    expectedAttackedTargetIds: [TARGET_A_ID],
...
const recoveryScenarioFor = (
  moveName: RegisteredBatch003MoveName,
...
describe('REG-003 registered move conformance', () => {
  it('certifies exactly Baby-Doll Eyes through Bone Club with linked evidence', () => {
    expect(Object.keys(REG_003_SCENARIOS_BY_MOVE)).toEqual([...REG_003_MOVE_NAMES])

    for (const [canonicalId, scenarios] of Object.entries(REG_003_SCENARIOS_BY_MOVE)) {
  ...
  it('retains the reviewed canonical mechanics without unresolved rule instructions', () => {
    const expected = {
      'Baby-Doll Eyes': { version: 1, ac: 2, damageBase: 0, damageClass: 'Status', range: '4, 1 Target, Priority, Social' },
      Bite: { version: 1, ac: 2, damageBase: 6, damageClass: 'Physical', range: 'Melee, 1 Target' },
      'Blaze Kick': { version: 1, ac: 4, damageBase: 9, damageClass: 'Physical', range: 'Melee, 1 Target', criticalRange: 18 },
      'Bleakwind Storm': { version: 2, ac: 5, damageBase: 10, damageClass: 'Special', range: '6, Ranged Blast 3, Smite' },
      'Blue Flare': { version: 2, ac: 5, damageBase: 13, damageClass: 'Special', range: '10, 1 Target, Smite' },
      'Body Slam': { version: 1, ac: 2, damageBase: 9, damageClass: 'Physical', range: 'Melee, 1 Target' },
      'Bolt Strike': { version: 2, ac: 5, damageBase: 13, damageClass: 'Physical', range: '10, 1 Target, Smite' },
      'Bone Club': { version: 1, ac: 5, damageBase: 7, damageClass: 'Physical', range: 'Melee, 1 Target' },
    } as const
    ...
    expect(explicitScriptForMove('Baby-Doll Eyes')?.stageSuggestions).toEqual([{
      recipient: 'target',
      key: 'atk',
      delta: -1,
      label: 'Baby-Doll Eyes lowers Attack: -1 Attack CS',
    }])
    expect(explicitScriptForMove('Bleakwind Storm')?.conditionSuggestions).toEqual([
      {
        recipient: 'target',
        condition: 'Flinch',
        action: 'add',
    ...
    for (const moveName of ['Blue Flare', 'Body Slam', 'Bolt Strike'] as const) {
      expect(explicitScriptForMove(moveName)?.conditionSuggestions).toHaveLength(1)
    }
  })
  ...
  it('rejects Baby-Doll Eyes Priority after the actor has acted without partial mutation', async () => {
    const scenario = recoveryScenarioFor('Baby-Doll Eyes')
    ...
    const command = commandFor(fixture, `${BABY_DOLL_EYES_REG_003_SCENARIOS[3].scenarioId}.command`)
