...
## LP-S3-001 — Add shared live-presence contract
...
## LP-S3-002 — Add server-side ephemeral map presence registry
...
## LP-S3-003 — Add presence access checks and snapshot route
...
## LP-S3-004 — Add presence heartbeat/update route
...
## LP-S3-005 — Broadcast transient presence updates over realtime
...
## LP-S3-006 — Add client composable for map presence
...
## LP-S3-007 — Render connected table participants
...
## LP-S3-008 — Publish local token selection and hover presence
...
## LP-S3-009 — Render remote token attention affordances
...
## LP-S3-010 — Add ephemeral map pings
...
## LP-S3-011 — Render pings in the isometric scene
...
## LP-S3-012 — Publish targeting and measurement intent
...
## LP-S3-013 — Render shared intent overlays
...
## LP-S3-014 — Add optional GM attention request
...
## LP-S3-015 — Add presence privacy and access regression tests
...
## LP-S3-016 — Add presence failure and degradation tests
...
## LP-S3-017 — Add presence metrics to the latency debug panel
...
## LP-S3-018 — Update live-play authority docs for ephemeral presence
