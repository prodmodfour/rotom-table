...
## LP-S4-001 — Audit current sequential live-play workflows
...
## LP-S4-002 — Add shared batch command guardrails
...
## LP-S4-003 — Add `clearHazards` live-play command contract
...
## LP-S4-004 — Implement server executor for `clearHazards`
...
## LP-S4-005 — Add API route and client result validation for `clearHazards`
...
## LP-S4-006 — Wire `clearHazards` into `useLivePlayCommands`
...
## LP-S4-007 — Replace clear-all hazards UI loop with `clearHazards`
...
## LP-S4-008 — Add `clearFieldEffects` live-play command contract
...
## LP-S4-009 — Implement server/API/client flow for `clearFieldEffects`
...
## LP-S4-010 — Replace clear-all field effects UI with `clearFieldEffects`
...
## LP-S4-011 — Add `editTerrainVoxels` batch command contract
...
## LP-S4-012 — Implement server/API/client flow for terrain voxel batches
...
## LP-S4-013 — Add terrain brush batching on the client
...
## LP-S4-014 — Add `editHazards` batch command contract
...
## LP-S4-015 — Implement server/API/client flow for hazard cell batches
...
## LP-S4-016 — Add hazard brush batching on the client
...
## LP-S4-017 — Add batch operation pending/recovery UI affordances
...
## LP-S4-018 — Add batch command chaos tests
...
## LP-S4-019 — Add operator smoke notes for live-play batch workflows
