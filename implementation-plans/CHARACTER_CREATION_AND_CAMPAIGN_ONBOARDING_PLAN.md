...
- Once done, move this file to `implementation-plans/done/CHARACTER_CREATION_AND_CAMPAIGN_ONBOARDING_PLAN.md` and update all authoritative references in the same change.

## Progress snapshot

- Plan tickets: **0 DONE / 100 total**
- Current ticket: **P9-001**
- Blocking dependency: **none; Plans 1–8 are complete**
- Primary product target: **trusted-table zero-to-first-encounter onboarding**
- Canonical creation coverage: **not yet inventoried**
- First playable vertical slice: **not yet implemented**
...
- [ ] **P9-001 — Audit the zero-to-first-encounter journey** — `TODO`
...
- [ ] **P9-002 — Inventory current sheet, profile, team, and ownership authority** — `TODO`
...
- [ ] **P9-003 — Inventory canonical Trainer creation rules** — `TODO`
...
- [ ] **P9-004 — Inventory canonical starter Pokémon creation rules** — `TODO`
...
- [ ] **P9-005 — Define the campaign onboarding policy matrix** — `TODO`
...
- [ ] **P9-006 — Define onboarding roles, privacy, and trust boundaries** — `TODO`
...
- [ ] **P9-007 — Define the onboarding completion rubric** — `TODO`
...
- [ ] **P9-008 — Define measurable onboarding UX success criteria** — `TODO`
...
- [ ] **P9-009 — Create canonical new-player onboarding fixtures** — `TODO`
...
- [ ] **P9-010 — Create onboarding failure, concurrency, and recovery fixtures** — `TODO`
...
- [ ] **P9-011 — Define the versioned `CampaignOnboardingPolicy` contract** — `TODO`
...
- [ ] **P9-012 — Define the versioned `OnboardingDraft` contract** — `TODO`
...
- [ ] **P9-013 — Define draft lifecycle, revision, and idempotency semantics** — `TODO`
...
- [ ] **P9-014 — Define stable choice, policy, and evidence identity** — `TODO`
...
- [ ] **P9-015 — Build the canonical character-creation catalog** — `TODO`
...
- [ ] **P9-016 — Define the validation issue and explanation contract** — `TODO`
...
- [ ] **P9-017 — Define derived previews and contribution explanations** — `TODO`
...
- [ ] **P9-018 — Define onboarding read sets, write sets, and atomicity** — `TODO`
...
- [ ] **P9-019 — Define realtime events and role projections** — `TODO`
...
- [ ] **P9-020 — Build strict onboarding contract and drift quality gates** — `TODO`
...
- [ ] **P9-021 — Add onboarding policy storage and migrations** — `TODO`
...
- [ ] **P9-022 — Implement the GM campaign-policy editor** — `TODO`
...
- [ ] **P9-023 — Implement policy publication and draft version binding** — `TODO`
...
- [ ] **P9-024 — Implement GM-created onboarding slots** — `TODO`
...
- [ ] **P9-025 — Implement player ownership and access policy** — `TODO`
...
- [ ] **P9-026 — Implement the GM onboarding queue** — `TODO`
...
- [ ] **P9-027 — Implement the player onboarding home and resume flow** — `TODO`
...
- [ ] **P9-028 — Implement cancel, restart, archive, and supersede flows** — `TODO`
...
- [ ] **P9-029 — Implement reviewed starting packages and campaign presets** — `TODO`
...
- [ ] **P9-030 — Certify policy, slot, ownership, and draft persistence** — `TODO`
...
- [ ] **P9-031 — Build the guided Trainer builder shell and decision state machine** — `TODO`
...
- [ ] **P9-032 — Implement Trainer identity and presentation** — `TODO`
...
- [ ] **P9-033 — Implement starting level and Trainer stat allocation** — `TODO`
...
- [ ] **P9-034 — Implement background and skill-rank decisions** — `TODO`
...
- [ ] **P9-035 — Implement the free Training Feature decision** — `TODO`
...
- [ ] **P9-036 — Implement Edge and Feature selection with prerequisites** — `TODO`
...
- [ ] **P9-037 — Implement Trainer classes, branches, and dependency-aware subchoices** — `TODO`
...
- [ ] **P9-038 — Implement starting money, inventory, equipment, and resources** — `TODO`
...
- [ ] **P9-039 — Implement the complete Trainer review and correction surface** — `TODO`
...
- [ ] **P9-040 — Certify the Trainer vertical slice** — `TODO`
...
- [ ] **P9-041 — Implement starter-pool discovery and species selection** — `TODO`
...
- [ ] **P9-042 — Implement Pokémon level, form, gender, and nature decisions** — `TODO`
...
- [ ] **P9-043 — Implement base and added-stat allocation** — `TODO`
...
- [ ] **P9-044 — Implement legal Ability selection** — `TODO`
...
- [ ] **P9-045 — Implement legal Move selection** — `TODO`
...
- [ ] **P9-046 — Implement Pokémon skills, capabilities, size, and movement preview** — `TODO`
...
- [ ] **P9-047 — Implement Pokémon identity and presentation** — `TODO`
...
- [ ] **P9-048 — Implement multiple starters and team composition** — `TODO`
...
- [ ] **P9-049 — Implement starter held-item, equipment, and ownership initialization** — `TODO`
...
- [ ] **P9-050 — Certify the Pokémon vertical slice** — `TODO`
...
- [ ] **P9-051 — Implement combined package validation** — `TODO`
...
- [ ] **P9-052 — Implement submission receipts and immutable review snapshots** — `TODO`
...
- [ ] **P9-053 — Build the GM review workspace** — `TODO`
...
- [ ] **P9-054 — Implement bounded change requests and player responses** — `TODO`
...
- [ ] **P9-055 — Implement explicit GM corrections and player acknowledgement** — `TODO`
...
- [ ] **P9-056 — Implement approval and commit-plan preview** — `TODO`
...
- [ ] **P9-057 — Implement atomic character-package creation and linking** — `TODO`
...
- [ ] **P9-058 — Implement exact retry, uncertain outcome, and reconciliation** — `TODO`
...
- [ ] **P9-059 — Publish authoritative completion and library realtime events** — `TODO`
...
- [ ] **P9-060 — Certify the first playable onboarding slice** — `TODO`
...
- [ ] **P9-061 — Define the existing-character intake contract** — `TODO`
...
- [ ] **P9-062 — Implement existing Trainer and team discovery** — `TODO`
...
- [ ] **P9-063 — Validate existing characters against campaign policy** — `TODO`
...
- [ ] **P9-064 — Classify intake deviations and house-rule exceptions** — `TODO`
...
- [ ] **P9-065 — Implement bounded intake repairs** — `TODO`
...
- [ ] **P9-066 — Implement intake ownership and profile linking** — `TODO`
...
- [ ] **P9-067 — Implement duplicate, rename, and reference-conflict handling** — `TODO`
...
- [ ] **P9-068 — Preserve history, resources, equipment, and attention state** — `TODO`
...
- [ ] **P9-069 — Implement atomic intake commit, retry, and rollback** — `TODO`
...
- [ ] **P9-070 — Certify existing-character intake** — `TODO`
...
- [ ] **P9-071 — Build the onboarding completion summary** — `TODO`
...
- [ ] **P9-072 — Implement the ready-for-play state and next actions** — `TODO`
...
- [ ] **P9-073 — Integrate onboarding into the Campaign dashboard** — `TODO`
...
- [ ] **P9-074 — Implement active-encounter onboarding handoff** — `TODO`
...
- [ ] **P9-075 — Integrate onboarded characters with the Encounter Builder** — `TODO`
...
- [ ] **P9-076 — Build the GM campaign roster and readiness overview** — `TODO`
...
- [ ] **P9-077 — Complete the player Trainer portal handoff** — `TODO`
...
- [ ] **P9-078 — Implement post-onboarding correction and reopen policy** — `TODO`
...
- [ ] **P9-079 — Persist onboarding provenance and audit history** — `TODO`
...
- [ ] **P9-080 — Certify zero-to-first-action and continuation journeys** — `TODO`
...
- [ ] **P9-081 — Implement the onboarding visual grammar and design-system fixtures** — `TODO`
...
- [ ] **P9-082 — Implement desktop, laptop, tablet, and mobile layouts** — `TODO`
...
- [ ] **P9-083 — Complete keyboard-only and switch-access operation** — `TODO`
...
- [ ] **P9-084 — Complete screen-reader structure, labels, and announcements** — `TODO`
...
- [ ] **P9-085 — Complete touch targets, help, and validation recovery** — `TODO`
...
- [ ] **P9-086 — Certify multi-tab and multi-device concurrency** — `TODO`
...
- [ ] **P9-087 — Certify restart, reconnect, and uncertain commit recovery** — `TODO`
...
- [ ] **P9-088 — Complete onboarding authorization, privacy, and abuse tests** — `TODO`
...
- [ ] **P9-089 — Enforce catalog, draft, validation, and rendering performance budgets** — `TODO`
...
- [ ] **P9-090 — Run responsive, accessibility, privacy, concurrency, and performance acceptance** — `TODO`
...
- [ ] **P9-091 — Certify complete canonical creation-rule coverage** — `TODO`
...
- [ ] **P9-092 — Certify the campaign-policy variant matrix** — `TODO`
...
- [ ] **P9-093 — Run GM/player multi-client onboarding acceptance** — `TODO`
...
- [ ] **P9-094 — Run fresh-database, upgrade, backup, and restore acceptance** — `TODO`
...
- [ ] **P9-095 — Run existing-campaign and intake acceptance** — `TODO`
...
- [ ] **P9-096 — Run failure, correction, rollback, and exact-retry acceptance** — `TODO`
...
- [ ] **P9-097 — Run golden zero-to-first-encounter campaigns** — `TODO`
...
- [ ] **P9-098 — Make guided onboarding the default new-player path** — `TODO`
...
- [ ] **P9-099 — Complete user, GM, contributor, and operator documentation** — `TODO`
...
- [ ] **P9-100 — Record final guided-onboarding alpha acceptance** — `TODO`
