...
| 9 | [Guided Character Creation and Campaign Onboarding](CHARACTER_CREATION_AND_CAMPAIGN_ONBOARDING_PLAN.md) | `TODO` | Active: P9-001 — audit the zero-to-first-encounter journey; 0 of 100 tickets complete. |
