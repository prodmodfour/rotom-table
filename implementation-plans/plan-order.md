...
| 13 | [1.0 Release Readiness](RELEASE_READINESS_PLAN.md) | `IN_PROGRESS` | Phases 1–5 accepted; executing P13-053 (52/86 tickets complete), `BLOCKED_BY: NONE`; rc.1 identity, upgrades, backup/restore, and the zero-gap catalog/finality sweep are certified. |
