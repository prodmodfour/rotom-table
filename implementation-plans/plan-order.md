...
| 11 | [Deferred Mechanics Closure](DEFERRED_MECHANICS_CLOSURE_PLAN.md) | `IN_PROGRESS` | Active: 0 of 92 tickets complete; `CURRENT_TICKET: P11-001`. Activation decisions for sources, the weapon-Move canonical home, item-action scope, the rod-fishing boundary, variant scales, the Battle Contest blend contract, generic Skill Checks, and ticket count are recorded in the ledger's decision record. |
