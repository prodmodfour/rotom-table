...
| 13 | [1.0 Release Readiness](RELEASE_READINESS_PLAN.md) | `IN_PROGRESS` | Phases 1–5 accepted; P13-053–P13-057 complete (57/86 tickets complete), paused at P13-058 with `BLOCKED_BY: OWNER_DECISION_P13_058`; rc.1 identity, upgrades, backup/restore, catalog/finality, repository presentation, and full tracked-tree classification are certified. |
