...
- Workshop UI and accessibility acceptance: **campaign route, role-projected ownership directory, verified Project wizard/choices, owner/GM Project and Egg cards, and role-projected hatch decision, bounded GM special review, accepted child reveal, recovery, and exact-replay choreography active; child destination/navigation pending**
...
- [ ] **BR-076 — Integrate child destination, team-limit explanations, box linkage, Trainer pages, and sheet navigation** — `IN_PROGRESS`
