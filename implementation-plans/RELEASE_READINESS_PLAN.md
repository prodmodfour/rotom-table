...
- **2026-08-27 — Fourth release candidate minted for evidence-complete rehearsal.** P13-074 performed `1.0.0-rc.3 → 1.0.0-rc.4` after regenerating the documentary-read proof and appending reviewed successor-chain edges without rewriting prior hashes. The full catalog gate then passed, including 2,457/2,457 final mechanics rows, 34 golden-journey tests, 115 privacy tests, and 88 performance tests. A new local annotated tag will identify the reviewed repair commit; all earlier tags remain immutable and publication remains owner-controlled.
