...
- **2026-08-27 — Second release-candidate identity minted for the full rehearsal.** The append-only mint authority performed the sequential `1.0.0-rc.1 → 1.0.0-rc.2` transition through P13-074 because the immutable first candidate predates upgrade, backup, catalog, distribution, notes, and release-command closure. Package, lock, notes, changelog, generated inventories, and current release gates derive or agree with `1.0.0-rc.2`; `v1.0.0-rc.1` remains unmoved. The local annotated `v1.0.0-rc.2` tag is reserved for the reviewed clean rehearsal commit, and publication remains owner-controlled.
