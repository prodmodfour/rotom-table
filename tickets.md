...
## LP-S1-001 — Add client-side live-play scope conflict utilities
...
## LP-S1-002 — Add a pending live-play command model
...
## LP-S1-003 — Split command transport status from command availability
...
## LP-S1-004 — Replace global in-flight blocking with scope-aware blocking
...
## LP-S1-005 — Add local prediction patch builders for `moveToken` and `turnToken`
...
## LP-S1-006 — Add a local prediction overlay store
...
## LP-S1-007 — Wire immediate visual prediction for token movement
...
## LP-S1-008 — Wire immediate visual prediction for token facing
...
## LP-S1-009 — Treat accepted SSE as first-class local command acknowledgement
...
## LP-S1-010 — Prefer accepted patches over full-map adoption for hot-path command responses
...
## LP-S1-011 — Add same-token movement coalescing before send
...
## LP-S1-012 — Add token-level pending/correction UI affordances
...
## LP-S1-013 — Add regression tests for scoped concurrency
...
## LP-S1-014 — Add a short live-play feel smoke note
