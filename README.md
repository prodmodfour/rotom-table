...
![Version](https://img.shields.io/badge/version-1.0.0--rc.7-ef4444)
...
The current candidate is **1.0.0-rc.7**, storage schema **v56**. A running private deployment reports the same package/build identity at:
