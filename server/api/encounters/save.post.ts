...
import { updateGmEncounterTableUseCase, type MutateGmEncounterTableInput } from '../../useCases/gmEncounterTableLibrary'
...
export default defineEventHandler(async (event) => {
  ...
  try {
    const result = updateGmEncounterTableUseCase(body)
