...
import { copyGmEncounterTableUseCase, type MutateGmEncounterTableInput } from '../../useCases/gmEncounterTableLibrary'
...
export default defineEventHandler(async (event) => {
  ...
  try {
    const result = copyGmEncounterTableUseCase(body)
