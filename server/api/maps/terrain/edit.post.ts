...
type EditTerrainVoxelsBody = Record<string, unknown>

const bodyField = (body: EditTerrainVoxelsBody, key: string): unknown => body[key]
...
export default defineEventHandler(async (event) => {
  ...
  const body = await readObjectBody<EditTerrainVoxelsBody>(event)
