...
type ModifyCombatStagesBody = Record<string, unknown>

const bodyField = (body: ModifyCombatStagesBody, key: string): unknown => body[key]
...
export default defineEventHandler(async (event) => {
  ...
  const body = await readObjectBody<ModifyCombatStagesBody>(event)
