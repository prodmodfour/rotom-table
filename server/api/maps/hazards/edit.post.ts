...
type EditHazardsBody = Record<string, unknown>

const bodyField = (body: EditHazardsBody, key: string): unknown => body[key]
...
export default defineEventHandler(async (event) => {
  ...
  const body = await readObjectBody<EditHazardsBody>(event)
