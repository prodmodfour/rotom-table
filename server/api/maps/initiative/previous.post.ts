...
type PreviousInitiativeBody = Record<string, unknown>

const bodyField = (body: PreviousInitiativeBody, key: string): unknown => body[key]
...
export default defineEventHandler(async (event) => {
  ...
  const body = await readObjectBody<PreviousInitiativeBody>(event)
