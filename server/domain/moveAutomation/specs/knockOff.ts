...
/**
 * Reviewed native-v2 runtime for canonical PTU Knock Off.
 *
 ...
 * Items or Trainer Accessory Slot Items. Itemless and unambiguous branches
 * resolve immediately; ambiguous candidates suspend behind one private,
 * actor-owned durable choice. The accepted-command boundary persists damage,
 * usage, exact item removal, and the map-ground destination atomically.
 */
