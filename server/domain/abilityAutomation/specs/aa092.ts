...
export const STEAM_ENGINE_ABILITY_SPEC = activatedTriggeredSpec('Steam Engine', 'aa092.steam-engine', 'move')
...
export const STICKY_SMOKE_ABILITY_SPEC = triggeredSpec('Sticky Smoke', 'aa092.sticky-smoke', 'move')
