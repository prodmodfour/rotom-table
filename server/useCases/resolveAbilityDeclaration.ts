                                ...
                                : mechanicOperation.mechanicId.startsWith('aa074.')
                                  ...
                                  : mechanicOperation.mechanicId.startsWith('aa075.')
                                    ...
                                    : mechanicOperation.mechanicId.startsWith('aa076.')
                                      ...
                                      : mechanicOperation.mechanicId.startsWith('aa077.')
                                        ? executeAa077ActivatedMechanic({
                                            context,
                                            operation: mechanicOperation,
                                            operationId: intent.intentId,
                                            choices: resolved.choices,
                                          })
                                        : mechanicOperation.mechanicId.startsWith('aa078.')
                                          ? executeAa078ActivatedMechanic({
                                              context,
                                              operation: mechanicOperation,
                                              operationId: intent.intentId,
                                              choices: resolved.choices,
                                            })
                                          : mechanicOperation.mechanicId.startsWith('aa079.')
                                            ? executeAa079ActivatedMechanic({
                                                context,
                                                operation: mechanicOperation,
                                                operationId: intent.intentId,
                                                choices: resolved.choices,
