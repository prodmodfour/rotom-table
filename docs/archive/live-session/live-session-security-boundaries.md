...
- hardening every legacy trust-based mutating route for arbitrary public internet access;
- turning legacy `/api/events` SSE or document autosave into session concurrency;
