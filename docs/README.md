...
- [Live session client integration](live-session-client-integration.md) — legacy live-session client boundaries, optimistic UX, disconnect recovery, and conflict/retry guidance; normal play uses player profiles on `/maps/<slug>`.
