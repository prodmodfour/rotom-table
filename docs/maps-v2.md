...
The counters, turn resources, zones, and pending-resolution-summary containers remain reserved and empty at this phase. Existing `hazards`, `fieldEffects`, `temporaryHitPoints`, and `moveUsage` fields remain separate and authoritative during the staged migration.
