...
- [ ] The deployed checkout is the intended app revision under `/srv/rotom-table/app` or the operator's equivalent app path.
- [ ] `ROTOM_CAMPAIGN_ROOT` points outside the app checkout, for example `/srv/rotom-table/campaign`.
