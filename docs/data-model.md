...
- personal maps, sheets, and trainer files should not be committed by default
...
Before publishing or sharing a branch, check `git status` and make sure private campaign notes, player information, unreleased story material, and one-off local data are not included.
