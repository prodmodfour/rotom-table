...
```bash
sudo grep -E 'campaign/(rotom-table\.sqlite|rotom-table\.sqlite-wal|rotom-table\.sqlite-shm|data/maps/|data/sheets/|data/trainers/|data/player-profiles/|encounter_tables/)' "${ARCHIVE}.listing"
```
