...
| Readiness evidence | Command-flow coverage, LAN smoke results, named-tunnel maintenance checks, local-mode checks, security and secret-hygiene readiness, persistence/recovery maintenance, concurrency notes, and readiness summary are linked. | [command-flow maintenance](live-session-command-flow-maintenance.md), [LAN manual smoke results](live-session-lan-manual-smoke-results.md), [security and secret-hygiene readiness](live-session-security-secret-hygiene-readiness.md), [readiness summary](live-session-readiness-summary.md), `tests/docs/productTerminologyGuard.test.ts`. |
...
| Readiness checks | [LAN manual smoke results](live-session-lan-manual-smoke-results.md), [named-tunnel maintenance checklist](live-session-named-tunnel-maintenance.md), [local-mode maintenance checks](live-session-local-mode-maintenance.md), [security and secret-hygiene readiness](live-session-security-secret-hygiene-readiness.md), [persistence/recovery maintenance](live-session-persistence-recovery-maintenance.md), [concurrency benchmark notes](live-session-concurrency-benchmark-notes.md), [readiness summary](live-session-readiness-summary.md), `tests/docs/liveSessionImplementationMaintenance.test.ts`, `tests/docs/liveSessionDocsMaintenance.test.ts`, `tests/docs/liveSessionReadinessSummary.test.ts`, and `tests/docs/productTerminologyGuard.test.ts`. |
