...
```json
{
  ...
  "message": "Track 2 session WebSocket command dispatch supports moveToken, turnToken, spawnToken, deleteToken, sendOutPokemon, modifyHp, modifyCombatStages, modifyConditions, useMove, useManeuver, useAbility, useOrder, setInitiative, nextInitiative, previousInitiative, placeHazard, removeHazard, setFieldEffect, removeFieldEffect, tickFieldEffectDurations, buildTerrainVoxel, and removeTerrainVoxel commands only.",
  "retryable": false,
  "currentRevision": 42
}
```
...
- [Track 2 concurrency benchmark notes](track-2-concurrency-benchmark-notes.md)
