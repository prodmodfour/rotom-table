...
Rotom Table runs locally with SQLite-backed runtime maps/sheets/group inventory/shop tables and remaining inspectable JSON maintenance data.
...
- runtime maps/sheets/group inventory/shop tables/folders/modes: `rotom-table.sqlite` (or `ROTOM_DB_PATH`)
- map/sheet/group-inventory/shop JSON import/export artifacts: `data/maps/`, `data/sheets/`, `data/trainers/`, `data/group-inventories/`, `data/shops/`
