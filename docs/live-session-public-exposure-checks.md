...
For the broader trust-boundary review, join-code limits, tunnel exposure risks, incident response, and non-hardened areas, see the [Live session security review](live-session-security-review.md). For the this review recheck of auth/session/cookie/permission boundaries and public exposure warnings after final audit passes, see the [Live session security readiness audit](live-session-security-readiness-audit.md).
