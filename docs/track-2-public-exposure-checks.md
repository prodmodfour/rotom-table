...
This guide records the additional hardening checks that run before a GM shares a Track 2 hosted session URL. It complements the [LAN hosting runbook](track-2-lan-hosting.md), [LAN manual smoke results](track-2-lan-manual-smoke-results.md), [named Cloudflare Tunnel runbook](track-2-cloudflare-tunnel-hosting.md), [deployment smoke checklist](track-2-deployment-smoke-checklist.md), [Quick Tunnel caveat](track-2-quick-tunnel-caveat.md), [session host runtime scripts](track-2-session-host-runtime.md), [dependency and runtime review](track-2-dependency-runtime-review.md), [security review](track-2-security-review.md), and [final session security audit](track-2-final-session-security-audit.md).
...
For the broader trust-boundary review, join-code limits, tunnel exposure risks, incident response, and non-hardened areas, see the [Track 2 security review](track-2-security-review.md). For the ticket 094 recheck of auth/session/cookie/permission boundaries and public exposure warnings after final audit passes, see the [Track 2 final session security audit](track-2-final-session-security-audit.md).
