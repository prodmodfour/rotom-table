...
- It does not cover LAN, named Cloudflare Tunnel, or Quick Tunnel behaviour. LAN and named-tunnel runbooks are separate hosting-hardening work; Quick Tunnel remains development smoke-test only when mentioned elsewhere.
