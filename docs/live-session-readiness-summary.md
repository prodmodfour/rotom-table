...
- [Live session security readiness audit](live-session-security-readiness-audit.md) reviews auth/session/cookie/permission boundaries, public exposure warnings, and remaining security non-goals.
