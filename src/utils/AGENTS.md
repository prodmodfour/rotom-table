...
- Prefer small reusable helpers and app-owned PTU reference data, but document non-automatable tabletop clauses in `automationNotes` rather than silently dropping them.
