...
export const MATERIAL_DEFINITIONS: readonly MaterialDefinition[] = [
  ...
  mat('wetland_peat_muck', 'Wetland Peat Muck', '#4f4537', ['habitat', 'sediment', 'wetland', 'peat', 'muck', 'organic']),
  mat('greywater_silt', 'Greywater Silt', '#6b746b', ['habitat', 'sediment', 'wetland', 'silt', 'greywater']),
  mat('alluvial_clay', 'Alluvial Clay', '#8a7461', ['habitat', 'sediment', 'wetland', 'clay', 'alluvial']),
