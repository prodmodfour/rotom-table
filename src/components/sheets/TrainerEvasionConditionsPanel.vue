...
<template>
  <div class="block">
    ...
    <p
      class="accuracy-line"
      title="Accuracy Roll modifier = Accuracy Combat Stage + condition modifiers + passive ability bonuses such as Compound Eyes or No Guard. A natural 1 still always misses."
    >
