...
<template>
  ...
  <p
    ...
    title="Accuracy Roll modifier = Accuracy Combat Stage + condition modifiers + Luck Incense held-item bonus + passive ability bonuses such as Compound Eyes or No Guard. A natural 1 still always misses."
  >
