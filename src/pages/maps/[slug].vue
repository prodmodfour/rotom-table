  ...
  <MapEditorLayout>
    ...
    <template #scene>
      <MapScenePanel
        ...
        :pending-move-hazard-cell-selections="pendingMoveResponses.hazardCellSelections.value"
        ...
        @choose-pending-move-hazard-cells="pendingMoveResponses.chooseHazardCells($event)"
